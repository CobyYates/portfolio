<template>
  <v-container class="pa-0" fluid>
    ...
    <v-parallax
      ...
      height="850"
    >
      <v-overlay :absolute="true" :opacity="0.4" :value="true">
        <v-row>
    ...
    <v-sheet class="mx-auto my-10" max-width="95%" color="transparent">
      <v-expand-transition class="lang">
        ...
        >
          <v-row class="fill-height" align="center" justify="center">
            <h2 class="green--text font-weight-light lang">
              {{ languages[model].lang }}
            </h2>
          </v-row>
        </v-sheet>
      </v-expand-transition>
      ...
      <v-slide-group light center-active show-arrows mandatory v-model="model">
        ...
        >
          <v-btn class="mx-12 py-6" height="120" width="120" icon>
            <v-icon
              size="120"
              :input-value="active"
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <div>
                <p class="text-h5 text-center">{{ project.title }}</p>
              </div>
            </v-overlay> -->
          </v-img>
        </v-card>
...
export default {
  ...
  data() {
    return {
      ...
      languages: [
        ...
        { lang: "Bootstrap", url: "mdi-bootstrap", color: "purple" },
  ...
  methods: {
    filterProjects(lang) {
      this.projects = this.$store.state.cards.filter((e) =>
        e.tags.includes(`${lang.lang}`)
      );
    },
    openProject(project) {
